...
import { PROJECTS, MARQUEE_ITEMS } from './data';
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        fontSize: 10, color: mp.fgDim, letterSpacing: '0.04em',
      }}>
        <span>/{proj.n}</span>
    ...
    <header style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
        <span style={{ fontSize: 22 }}>
          <PixelMark color={mp.accent} sessionKey="tfs-mboot-top" />
        </span>
        <span style={{
          fontFamily: '"Inter", system-ui, sans-serif',
          fontSize: 12, color: mp.fgDim,
        }}>twofivesix</span>
      </div>
      <button onClick={onMenu} aria-label="Menu" style={{
        background: 'none', border: `1px solid ${mp.rule}`,
        padding: '8px 12px', borderRadius: 2,
        fontFamily: '"JetBrains Mono", monospace',
        fontSize: 11, letterSpacing: '0.08em',
        color: mp.fg, cursor: 'pointer',
      }}>MENU</button>
    </header>
  );
}
      ...
      <aside style={{
        ...
        <div style={{
          ...
          <span style={{
            ...
            letterSpacing: '0.08em', color: mp.fgDim,
          }}>/MENU</span>
        ...
        <nav style={{ display: 'grid', gap: 4, flex: 1 }}>
          {[['/01', 'Work'], ['/02', 'Studio'], ['/03', 'Journal'], ['/04', 'Contact']].map(([n, l]) => (
            <a key={l} href="#" onClick={onClose} style={{
              display: 'grid', gridTemplateColumns: '40px 1fr',
              alignItems: 'baseline', gap: 8,
              padding: '14px 0',
              borderBottom: `1px solid ${mp.rule}`,
              textDecoration: 'none', color: mp.fg,
            }}>
              <span style={{
                fontFamily: '"JetBrains Mono", monospace', fontSize: 11,
                color: mp.fgDim, letterSpacing: '0.08em',
              }}>{n}</span>
              <span style={{
        ...
        <div style={{
          marginTop: 28,
          fontFamily: '"JetBrains Mono", monospace',
          fontSize: 10, letterSpacing: '0.08em', color: mp.fgDim,
          lineHeight: 1.6,
        }}>
          <div style={{ color: mp.fg, marginBottom: 8 }}>/CONTACT</div>
    ...
    <section style={{ padding: '40px 20px 28px' }}>
      <div data-mreveal style={{
        ...
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: 6 }}>
          <span style={{
            width: 5, height: 5, background: mp.accent2,
            display: 'inline-block', borderRadius: '50%',
            boxShadow: `0 0 0 3px ${mp.accent2}33`,
          }} />
      ...
      <h1 data-mreveal data-mreveal-delay="80" style={{
        ...
        margin: 0, color: mp.fg,
      }}>
        Websites for<br />
        Uganda&rsquo;s most<br />
        <em style={{ fontStyle: 'italic', fontWeight: 300, color: mp.accent }}>ambitious</em><br />
        businesses.
      </h1>
      ...
      <p data-mreveal data-mreveal-delay="160" style={{
        ...
        color: mp.fgDim, margin: '24px 0 0',
      }}>
      ...
      <div data-mreveal data-mreveal-delay="220" style={{ display: 'grid', gap: 8, marginTop: 28 }}>
        <a href="#work" style={{
          background: mp.accent, color: '#FAFAF7',
          padding: '16px 18px', borderRadius: 2,
          fontFamily: '"JetBrains Mono", monospace',
          fontSize: 12, letterSpacing: '0.08em',
          textDecoration: 'none',
          display: 'flex', justifyContent: 'space-between', alignItems: 'center',
          border: `1px solid ${mp.accent}`,
        }}>
          <span>SEE THE WORK</span><span aria-hidden>→</span>
        </a>
        <a href="#mstart" style={{
          background: 'transparent', color: mp.fg,
          padding: '16px 18px', borderRadius: 2,
          fontFamily: '"JetBrains Mono", monospace',
          fontSize: 12, letterSpacing: '0.08em',
          textDecoration: 'none',
          display: 'flex', justifyContent: 'space-between', alignItems: 'center',
          border: `1px solid ${mp.fg}55`,
        }}>
      ...
      <div data-mreveal data-mreveal-delay="280" style={{
        ...
        color: mp.fgDim, lineHeight: 1.55,
        display: 'grid', gridTemplateColumns: '12px 1fr',
        columnGap: 12, rowGap: 6,
      }}>
        <span style={{ color: mp.accent2 }}>›</span>
        <span style={{ color: mp.fg }}>Bank-grade engineering. Founding member of Afropocene.</span>
        <span style={{ color: mp.accent2 }}>›</span>
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        width: 'max-content',
        animation: 'tfsm-marquee 28s linear infinite',
        fontFamily: '"JetBrains Mono", monospace',
        ...
        {items.map((w, i) => (
          <span key={i} style={{ display: 'inline-flex', alignItems: 'center', gap: 28 }}>
            {w}
            <span style={{ width: 4, height: 4, background: mp.accent, display: 'inline-block' }} />
          </span>
        ))}
      </div>
    </div>
  ...
  return (
    <section id="work" style={{ padding: '56px 20px 24px' }}>
      ...
      <h2 data-mreveal data-mreveal-delay="60" style={{
        ...
        margin: '0 0 40px', color: mp.fg,
      }}>
        Eight projects.<br />
        <em style={{ color: mp.accent, fontStyle: 'italic', fontWeight: 300 }}>One studio.</em><br />
        <span style={{ color: mp.fgDim }}>Built to last.</span>
      </h2>
      ...
      <a href="#" style={{
        ...
        fontFamily: '"JetBrains Mono", monospace',
        fontSize: 12, letterSpacing: '0.08em',
        color: mp.fg, textDecoration: 'none',
      }}>
...
function MStudio() {
  ...
  return (
    <section style={{ padding: '64px 20px 40px', borderTop: `1px solid ${mp.rule}` }}>
      <div data-mreveal style={{
        fontFamily: '"JetBrains Mono", monospace',
        fontSize: 10, letterSpacing: '0.08em', color: mp.fgDim,
        marginBottom: 16,
      ...
      <div data-mreveal data-mreveal-delay="120" style={{
        ...
        borderBottom: `1px solid ${mp.rule}`,
        fontFamily: '"JetBrains Mono", monospace',
        fontSize: 10, letterSpacing: '0.06em', color: mp.fgDim,
        marginBottom: 32,
      }}>
        <div><div style={{ color: mp.fg }}>SINCE</div><div style={{ marginTop: 4 }}>2021</div></div>
        <div><div style={{ color: mp.fg }}>SHIPPED</div><div style={{ marginTop: 4 }}>40+ projects</div></div>
        <div><div style={{ color: mp.fg }}>HEAD</div><div style={{ marginTop: 4 }}>2 + collabs</div></div>
      </div>
      ...
      {caps.map((c, i) => (
        <div key={c.l} data-mreveal data-mreveal-delay={i * 50} style={{
          ...
          <div style={{
            ...
            color: mp.accent, marginBottom: 6,
          }}>/{c.l}</div>
          <div style={{
            fontFamily: '"Fraunces", Georgia, serif', fontWeight: 300,
...
function MStart() {
  ...
  return (
    <section id="mstart" style={{
      background: mp.fg, color: mp.bg,
      padding: '64px 20px 56px', marginTop: 24,
    }}>
      <div style={{
        fontFamily: '"JetBrains Mono", monospace',
        fontSize: 10, letterSpacing: '0.08em',
        color: `${mp.bg}88`, marginBottom: 14,
      }}>/SECTION 03 — START</div>

      <h2 style={{
        fontFamily: '"Fraunces", Georgia, serif', fontWeight: 300,
        fontSize: 42, lineHeight: 0.96, letterSpacing: '-0.025em',
        margin: '0 0 36px', color: mp.bg,
      }}>
        Tell us what<br />
        you&rsquo;re<br />
        <em style={{ color: mp.accent2, fontStyle: 'italic', fontWeight: 300 }}>building.</em>
      </h2>
      ...
      <div style={{
        ...
        {['SCOPE', 'BUDGET', 'WHEN'].map((s, i) => (
          <button key={s} onClick={() => setStage(i)} style={{
            ...
            color: i === stage ? mp.accent2 : `${mp.bg}66`,
      ...
      {stage === 0 && (
        <div>
          <label style={{
            fontFamily: '"JetBrains Mono", monospace',
            fontSize: 10, letterSpacing: '0.08em', color: `${mp.bg}99`,
            ...
            {['E-commerce', 'Brand site', 'Web app', 'Booking', 'CMS', 'Brand', 'Other'].map((s) => {
              ...
              return (
                <button key={s} onClick={() => setData((d) => ({
                  ...
                  border: `1px solid ${on ? mp.accent2 : mp.bg + '44'}`,
                  background: on ? mp.accent2 : 'transparent',
                  color: on ? mp.fg : mp.bg,
                  fontFamily: '"JetBrains Mono", monospace',
          ...
          {['Under 10k', '10k — 25k', '25k — 60k', '60k +', "Let's discuss"].map((b) => {
            ...
            return (
              <button key={b} onClick={() => setData((d) => ({ ...d, budget: b }))} style={{
                ...
                borderBottom: `1px solid ${mp.bg}22`,
                color: on ? mp.accent2 : mp.bg,
                fontFamily: '"Fraunces", Georgia, serif', fontWeight: 300,
                ...
                <span style={{
                  fontFamily: '"JetBrains Mono", monospace',
                  fontSize: 11, color: on ? mp.accent2 : `${mp.bg}66`,
                }}>{on ? '◉' : '○'}</span>
              </button>
            );
          })}
      ...
      {stage === 2 && (
        <div>
          ...
          <input style={{
            ...
            borderBottom: `1px solid ${mp.bg}55`, color: mp.bg,
            padding: '12px 0',
            fontFamily: '"Fraunces", Georgia, serif', fontWeight: 300,
      ...
      <div style={{
        ...
        <button onClick={() => setStage((s) => Math.max(0, s - 1))} style={{
          ...
          color: stage === 0 ? `${mp.bg}33` : mp.bg,
          fontFamily: '"JetBrains Mono", monospace',
          fontSize: 11, letterSpacing: '0.08em',
        }}>← BACK</button>
        <button onClick={() => stage < 2 ? setStage(stage + 1) : null} style={{
          background: mp.accent2, color: mp.fg,
  ...
  return (
    <footer style={{ padding: '48px 20px 28px' }}>
      <div style={{ fontSize: 80, lineHeight: 1, marginBottom: 14 }}>
        <PixelMark color={mp.accent} sessionKey="tfs-mboot-foot" />
      </div>
      <div style={{
        fontFamily: '"Inter", system-ui, sans-serif',
        fontSize: 13, color: mp.fgDim, marginBottom: 32,
      }}>twofivesix studio · Kampala, Uganda</div>

      <div style={{
        display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 24,
        fontFamily: '"JetBrains Mono", monospace',
        fontSize: 11, letterSpacing: '0.06em', color: mp.fgDim,
        paddingTop: 24, borderTop: `1px solid ${mp.rule}`,
      }}>
        <div>
          <div style={{ color: mp.fg, marginBottom: 10 }}>/SITE</div>
          <div style={{ display: 'grid', gap: 6 }}>
            <span>Work</span><span>Studio</span><span>Journal</span><span>Contact</span>
          </div>
        </div>
        <div>
          <div style={{ color: mp.fg, marginBottom: 10 }}>/ELSEWHERE</div>
          <div style={{ display: 'grid', gap: 6 }}>
            <span>Are.na</span><span>Read.cv</span><span>Github</span><span>Instagram</span>
          </div>
        </div>
        <div style={{ gridColumn: 'span 2' }}>
          <div style={{ color: mp.fg, marginBottom: 10 }}>/CONTACT</div>
          <div style={{ display: 'grid', gap: 6 }}>
      ...
      <div style={{
        marginTop: 32, paddingTop: 16, borderTop: `1px solid ${mp.rule}`,
        fontFamily: '"JetBrains Mono", monospace',
        fontSize: 10, letterSpacing: '0.06em', color: mp.fgDim,
        display: 'flex', justifyContent: 'space-between',
      }}>
...
export default function MobileHome() {
  ...
  return (
    <div style={{
      ...
      minHeight: '100vh',
      fontFamily: '"Inter", system-ui, sans-serif',
      backgroundImage: `radial-gradient(${mp.grid} 1px, transparent 1px)`,
